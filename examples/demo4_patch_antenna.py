...
if __name__=="__main__":
    ...
    model.check_version("2.5.0") # Checks version compatibility.
    ...
    model.mw.set_frequency_range(f1, f2, 100)
    ...
    model.view(bc=True)
    data = model.mw.run_sweep(parallel=True, n_workers=12, multi_processing=True)
